...
def allocate(service, resources):
    try:
        LOG.info("User-Management: Dependencies: allocate: " + str(resources) + ", " + str(service))
...
# TODO CALL TO SLA:
def initializes_sla(service, resources):
    try:
        LOG.info("User-Management: Dependencies: initializes_sla: " + str(resources) + ", " + str(service))
