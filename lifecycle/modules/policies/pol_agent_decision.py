...
def select_agents_from_list(agents_list, service_type):
    ...
    if service_type == SERVICE_COMPSS:
        LOG.debug("[lifecycle.modules.policies.pol_agent_decision] [select_agents_from_list] [SERVICE_COMPSS] service will be deployed in all selected agents")
    ...
    # OTHERS
        ...
        LOG.debug("[lifecycle.modules.policies.pol_agent_decision] [select_agents_from_list] [" + service_type + "] service will be deployed in first agent: " + str(list_of_agents))

    LOG.debug("[lifecycle.modules.policies.pol_agent_decision] [select_agents_from_list] agents final list: " + str(list_of_agents))
